...
use lib\entities\PortfolioProject;
use lib\entities\PortfolioCategory;
use lib\entities\PortfolioGalleryItem;
use lib\entities\PortfolioLeadingItem;
use lib\entities\PortfolioAboutLink;

class PortfolioController extends BackController {
	...
	public function executeInsertProject(HTTPRequest $request) {
		...
		if ($request->postExists('project-name')) {
			...
			try {
				$project = new PortfolioProject($projectData);
	...
	public function executeUpdateProject(HTTPRequest $request) {
	...
	public function executeDeleteProject(HTTPRequest $request) {
	...
	public function executeInsertCategory(HTTPRequest $request) {
		...
		if ($request->postExists('category-name')) {
			...
			try {
				$category = new PortfolioCategory($categoryData);
			} catch(\InvalidArgumentException $e) {
				$this->page()->addVar('error', $e->getMessage());
				return;
			}
	...
	public function executeUpdateCategory(HTTPRequest $request) {
	...
	public function executeDeleteCategory(HTTPRequest $request) {
	...
	public function executeListGalleryItems(HTTPRequest $request) {
	...
	public function executeInsertGalleryItem(HTTPRequest $request) {
		...
		if ($request->postExists('galleryItem-title')) {
			...
			try {
				$galleryItem = PortfolioGalleryItem::build($galleryItemData);
			} catch(\InvalidArgumentException $e) {
				$this->page()->addVar('error', $e->getMessage());
				return;
			}
	...
	public function executeUpdateGalleryItem(HTTPRequest $request) {
	...
	public function executeDeleteGalleryItem(HTTPRequest $request) {
	...
	public function executeInsertLeadingItem(HTTPRequest $request) {
		...
		if ($request->postExists('leadingItem-place')) {
			...
			try {
				$leadingItem = new PortfolioLeadingItem($leadingItemData);
			} catch(\InvalidArgumentException $e) {
				$this->page()->addVar('error', $e->getMessage());
				return;
			}
	...
	public function executeDeleteLeadingItem(HTTPRequest $request) {
	...
	public function executeUpdateAboutPage(HTTPRequest $request) {
	...
	public function executeInsertAboutLink(HTTPRequest $request) {
		...
		if ($request->postExists('aboutLink-title')) {
			...
			try {
				$aboutLink = new PortfolioAboutLink($aboutLinkData);
			} catch(\InvalidArgumentException $e) {
				$this->page()->addVar('error', $e->getMessage());
				return;
			}
	...
	public function executeUpdateAboutLink(HTTPRequest $request) {
	...
	public function executeDeleteAboutLink(HTTPRequest $request) {
